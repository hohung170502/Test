...
//       try {
//         setLoading(true);
//         const result = await getRoles({ pageIndex, pageSize, isDeep: true });
...
//         }
//       } catch (error) {
//         console.error("❌ Lỗi khi gọi getRoles:", error);
            ...
            <table className="w-full border-collapse min-w-[400px]">
              <thead className="bg-gray-100 border-b">
                <tr className="text-gray-600 text-left text-sm ">
                  ...
                  <th className="px-3 py-3 min-w-[100px]">Quyền quản lý</th>
                ...
                {roles.map((role) => (
                  <tr key={role.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-3 py-3 text-blue-600 hover:underline cursor-pointer">
                      <Link href={`/admin/policies/edit/${role.id}`}>
                        {role.name}
                      </Link>
                    </td>
                    <td className="px-3 py-3 ">
